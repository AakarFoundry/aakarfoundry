...
export function DesignFoundary() {
...
>
  <Grid container spacing={4}>
    ...
    <Grid item xs={12} sm={6}>
    <Typography variant="subtitle1"  sx={{ textAlign: 'left', color: '#054470',fontWeight: '650', fontSize: '1.2rem'}} > 2 Net Raw Casting Wt (Kg)   * </Typography>
